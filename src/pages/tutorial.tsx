      ...
      <div className="flex flex-col gap-8 overflow-auto py-4 px-6 sm:py-8 sm:px-10">
        <div className="flex flex-col gap-4 sm:flex-row md:justify-between">
          <Paragraph>
            ...
            <ol className="flex list-inside list-decimal flex-col gap-2 text-sm md:text-base">
              <li>
              ...
              <li>
                Now go to our home page and click <b>Import</b>, after entering
                the required information then you&apos;re done!
              </li>
              <p className="text-[0.825rem] before:pr-1 before:text-red-400 before:content-['*']">
